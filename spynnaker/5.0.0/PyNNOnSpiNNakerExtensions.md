...
1. Download the sPyNNaker source code as a [zip](https://github.com/SpiNNakerManchester/sPyNNaker/archive/5.0.0.zip) or [tar.gz](https://github.com/SpiNNakerManchester/sPyNNaker/archive/5.0.0.tar.gz)
