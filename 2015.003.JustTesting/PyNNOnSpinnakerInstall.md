...
```pip install SpiNNMachine=2015.002```
1. install pacman
```pip install spinnaker_pacman=2015.002```
1. install spinnman
```pip install spinnman=2015.002```
...
1. install spinnMachine
```pip install SpiNNMachine=2015.002 --user```
1. install pacman
```pip install spinnaker_pacman=2015.002 --user```
1. install spinnman
```pip install spinnman=2015.002 --user```
1. install data specification
