...
1. [Install Development Dependencies](/common_pages/6.0.0/Compiler.html)
...
1. Download the current version of SpiNNaker Tools from [here](https://github.com/SpiNNakerManchester/spinnaker_tools/releases/download/v3.4.0/spinnaker_tools_3.4.0.tar.gz)
